...
type Server struct {
	...
	// header names. See https://github.com/fr-edy/fasthttp/issues/57
	// for details.
	//
...
func (s *Server) Serve(ln net.Listener) error {
	...
	for {
		...
		if !wp.Serve(c) {
			...
			//
			// See also: https://github.com/fr-edy/fasthttp/pull/485#discussion_r239994990
